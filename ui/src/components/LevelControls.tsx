    ...
    <section className="rounded-3xl border border-slate-800 bg-panel p-6 shadow-xl">
      <div className="mb-5 flex items-center justify-between border-b border-slate-800/80 pb-3">
        ...
        <button
          type="button"
          onClick={onReset}
          className="flex items-center gap-1 rounded-lg px-2 py-1 text-sm text-slate-400 hover:bg-slate-800/50 hover:text-slate-300"
        >
      ...
      <div className="grid grid-cols-1 items-start gap-6 md:grid-cols-12">
        <div className="space-y-3 md:col-span-8">
          <div className="flex flex-wrap items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className="w-24 rounded-xl border border-slate-700 bg-ink px-2.5 py-1.5 text-right font-mono text-base font-semibold text-white focus:border-accent focus:outline-none"
              />
              <span className="text-sm text-slate-400">dB SPL</span>
            </div>
          </div>
          ...
          />
          <div className="flex justify-between px-0.5 font-mono text-sm text-slate-400">
            <span>{min} dB</span>
        ...
        <div className="space-y-2 rounded-2xl border border-slate-700/50 bg-inset p-4 md:col-span-4">
          <label
            htmlFor="reference"
            className="flex items-center gap-1.5 text-base font-semibold text-slate-300"
          >
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="w-full rounded-xl border border-slate-700 bg-ink px-3 py-1.5 font-mono text-base font-semibold text-white focus:border-accent focus:outline-none"
            />
            <span className="font-mono text-sm text-slate-400">dB</span>
          </div>
          ...
          {!referenceIsMeasured && (
            <p className="text-sm leading-snug text-amber-300/90">
